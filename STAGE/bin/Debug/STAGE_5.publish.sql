...
CREATE DATABASE [$(DatabaseName)]
    ...
    LOG ON (NAME = [$(DatabaseName)_log], FILENAME = N'$(DefaultLogPath)$(DefaultFilePrefix)_Primary.ldf') COLLATE Cyrillic_General_CI_AI
GO
USE [$(DatabaseName)];
...
END
GO
PRINT N'Creating [ETL].[addSource]...';
